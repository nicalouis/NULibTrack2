...
public class LibraryDB {
    ...
    // ✅ prevent duplicate
    for (Book r : reservations) {
        if (r == b) return "ALREADY";
    }
    ...
    if (b.available) {
        ...
        return "NO_QUEUE"; // ✅ correct
    }


    // ✅ NOT AVAILABLE → compute queue
    int queueNumber = 1;
    ...
    addNotification("Reserved: " + b.title + " | Queue #" + queueNumber);


    triggerUI();


    return String.valueOf(queueNumber); // ✅ THIS FIXES IT
}
    // ================= CANCEL RESERVE =================
